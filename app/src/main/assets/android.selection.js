...
android.selection.longTouch = function() {
    try {
        ...
        //debugging
        console.log("android.selection.lastTouchPoint.x: "); //찍힘
        console.log(android.selection.lastTouchPoint.x);
        console.log("android.selection.lastTouchPoint.y: "); //찍힘
        console.log(android.selection.lastTouchPoint.y);

        //debugging
        console.log("range: "); //찍힘
        console.log(range)
        ...
        var text = range.toString();
          ...
          //debugging
          console.log("longTouch"); //찍힘
          console.log(text);

         //유저 클릭한 텍스트 웹페이지에 표시
          var element = document.getElementById('change0');
...
android.selection.selectionChanged = function(isReallyChanged) {
    try {
        ...
        console.log("test");
        console.log(text); //->undefined라고 뜸. 음, 여기서는 아직 셀렉된 단어가 확정이 안 된 단계인듯
       ...
       // console.log(window.getSelection()); //이거 콘솔로 찍으니까 다른 로그가 안 뜸;;;
        ...
        //debugging
        console.log("rangyRange"); //이것조차 안 찍힘
